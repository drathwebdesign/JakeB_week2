...
public class VehicleMovement : MonoBehaviour {
    ...
    private void Awake() {
        ...
        playerControls.Vehicle.Horn.performed += ctx => HonkHorn();
        playerControls.Vehicle.Handbrake.started += ctx => isHandbrakeActive = true;
        playerControls.Vehicle.Handbrake.canceled += ctx => isHandbrakeActive = false;
        playerControls.Vehicle.Nitros.started += ctx => StartNitros();
        playerControls.Vehicle.Nitros.canceled += ctx => StopNitros();
        playerControls.Vehicle.Unstuck.started += ctx => UnstuckVehicle();
